...
for item in data:
    ...
    html += f"<iframe width='450' height='250' frameborder='0' style='border:0' src='https://www.google.com/maps/embed/v1/place?key=AIzaSyBxFvErb0a3ff7YOfmaKfUCazqCVaktU08&q={item['locatie']}' allowfullscreen> </iframe> <hr><br>\n"
